...
if ( !function_exists( 'booklovers_template_news_portfolio_theme_setup' ) ) {
	add_action( 'booklovers_action_before_init_theme', 'booklovers_template_news_portfolio_theme_setup', 1 );
	function booklovers_template_news_portfolio_theme_setup() {
		booklovers_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'booklovers'),
...
// Template output
if ( !function_exists( 'booklovers_template_news_portfolio_output' ) ) {
	function booklovers_template_news_portfolio_output($post_options, $post_data) {
