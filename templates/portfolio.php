...
if ( !function_exists( 'booklovers_template_portfolio_theme_setup' ) ) {
	add_action( 'booklovers_action_before_init_theme', 'booklovers_template_portfolio_theme_setup', 1 );
	function booklovers_template_portfolio_theme_setup() {
		booklovers_add_template(array(
			'layout' => 'portfolio_2',
			'template' => 'portfolio',
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile (with hovers, different height) /2 columns/', 'booklovers'),
		...
		booklovers_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /3 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium image', 'booklovers'),
			'w'		 => 370,
			'h_crop' => 209,
			'h'		 => null
		...
		booklovers_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /4 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium image', 'booklovers'),
			'w'		 => 370,
			'h_crop' => 209,
			'h'		 => null
		...
		booklovers_add_template(array(
			...
			'title'  => esc_html__('Grid tile (with hovers, equal height) /2 columns/', 'booklovers'),
		...
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /3 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 209
		));
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /4 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 209
		));
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile (with hovers, width=height) /2 columns/', 'booklovers'),
		...
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /3 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 370
		));
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /4 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 370
		));
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored excerpt', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 370
		));
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile (with hovers, width=height) /2 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h' 	 => 370
		));
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /3 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 370
		));
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /4 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 370
		));
		booklovers_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /2 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h' 	 => 370
		));
		booklovers_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /3 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 370
		));
		booklovers_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /4 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 370
		));
		booklovers_add_template(array(
			...
			'title'  => esc_html__('Alternative grid (with hovers) /2 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h' 	 => 370
		));
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /3 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 370
		));
		booklovers_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /4 columns/', 'booklovers'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'booklovers'),
			'w'		 => 370,
			'h'		 => 370
		));
		// Add template specific scripts
		add_action('booklovers_action_blog_scripts', 'booklovers_template_portfolio_add_scripts');
	}
}

// Add template specific scripts
if (!function_exists('booklovers_template_portfolio_add_scripts')) {
	//Handler of add_action('booklovers_action_blog_scripts', 'booklovers_template_portfolio_add_scripts');
	function booklovers_template_portfolio_add_scripts($style) {
		if (booklovers_substr($style, 0, 10) == 'portfolio_' 
			|| booklovers_substr($style, 0, 5) == 'grid_' 
			|| booklovers_substr($style, 0, 7) == 'square_' 
			|| booklovers_substr($style, 0, 6) == 'short_'
			|| booklovers_substr($style, 0, 6) == 'alter_' 
			|| booklovers_substr($style, 0, 8) == 'colored_') {
...
// Template output
if ( !function_exists( 'booklovers_template_portfolio_output' ) ) {
	function booklovers_template_portfolio_output($post_options, $post_data) {
		...
		if ($style == 'colored' && $columns==1) {				// colored excerpt style (1 column)
			...
			<div class="isotope_item isotope_item_colored isotope_item_colored_1 isotope_column_1
						...
						?>">
				<<?php booklovers_show_layout($tag); ?> class="post_item post_item_colored post_item_colored_1
					...
					<div class="post_content isotope_item_content">
						<div class="post_featured img">
							...
							*/
							...
							booklovers_show_layout($post_data['post_thumb'], $link_start, $link_end);
							...
							$new = booklovers_get_custom_option('mark_as_new', '', $post_data['post_id'], $post_data['post_type']);					// !!!!!! Get option from specified post
							if ($new && $new > date('Y-m-d')) {
								?><div class="post_mark_new"><?php esc_html_e('NEW', 'booklovers'); ?></div><?php
							}
							?>
						</div>
		
						<div class="post_description clearfix">
							<h5 class="post_title"><?php booklovers_show_layout($post_data['post_title'], $link_start, $link_end); ?></h5>
							...
							<div class="post_descr">
								<?php booklovers_show_layout($post_data['post_excerpt']); ?>
							</div>
							<?php if ($post_data['post_link'] != '') { ?>
								<div class="post_buttons">
									<?php booklovers_show_layout(booklovers_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('LEARN MORE', 'booklovers'))); ?>
								</div>
							<?php } ?>
						</div>
					</div>				<!-- /.post_content -->
			...
			if ($style=='alter') {
				...
				$alter_size = explode('_', booklovers_get_custom_option('alter_thumb_size', '1_1', $post_data['post_id'], $post_data['post_type']));	// !!!!!! Get option from specified post
				$alter_size[0] = max(1, $alter_size[0]);
				$alter_size[1] = max(1, empty($alter_size[1]) ? 1 : $alter_size[1]);
				$post_data['post_thumb'] = booklovers_get_resized_image_tag($post_data['post_attachment'], 
					 ...
					 ?>">
							...
							if ($style=='colored') {
								...
								<div class="post_descr">
									...
									$category = !empty($post_data['post_terms'][$post_data['post_taxonomy']]->terms) 
												...
												: '';
									?>
									<div class="post_category"><?php booklovers_show_layout($category); ?></div>
									<?php booklovers_show_layout($reviews_summary); ?>
								</div>
								<?php
							}
						...
						if ($style!='colored') {
							...
							<div class="post_info_wrap info"><div class="info-back">
								...
								<?php
								if ($show_title) {
									?><h4 class="post_title"><?php booklovers_show_layout($post_data['post_title'], $link_start, $link_end); ?></h4><?php
								}
								?>
								...
								<?php
									if ($post_data['post_protected']) {
										booklovers_show_layout($post_data['post_excerpt'], $link_start, $link_end);
									} else {
										...
										if ($post_data['post_excerpt']) {
											echo in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status')) 
												...
												: '<p>' . ($link_start) 
													. (booklovers_strpos($post_options['hover'], 'square')!==false
														? strip_tags($post_data['post_excerpt'])
														: trim(booklovers_strshort($post_data['post_excerpt'], isset($post_options['descr']) ? $post_options['descr'] : booklovers_get_custom_option('post_excerpt_maxlength_masonry'))) 
														)
													. ($link_end) . '</p>';
										}
										if ($post_data['post_link'] != '') {
											?><p class="post_buttons"><?php
											if (!booklovers_param_is_off($post_options['readmore']) && !in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status'))) {
