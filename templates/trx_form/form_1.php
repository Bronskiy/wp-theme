...
if ( !function_exists( 'booklovers_template_form_1_theme_setup' ) ) {
	add_action( 'booklovers_action_before_init_theme', 'booklovers_template_form_1_theme_setup', 1 );
	function booklovers_template_form_1_theme_setup() {
		booklovers_add_template(array(
			'layout' => 'form_1',
			'mode'   => 'forms',
			'title'  => esc_html__('Contact Form 1', 'booklovers')
			));
	}
}

// Template output
if ( !function_exists( 'booklovers_template_form_1_output' ) ) {
	function booklovers_template_form_1_output($post_options, $post_data) {
		?>
