...
if ( !function_exists( 'booklovers_template_testimonials_2_theme_setup' ) ) {
	add_action( 'booklovers_action_before_init_theme', 'booklovers_template_testimonials_2_theme_setup', 1 );
	function booklovers_template_testimonials_2_theme_setup() {
		booklovers_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 2/', 'booklovers')
		));
	}
}

// Template output
if ( !function_exists( 'booklovers_template_testimonials_2_output' ) ) {
	function booklovers_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
