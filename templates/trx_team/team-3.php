...
if ( !function_exists( 'booklovers_template_team_3_theme_setup' ) ) {
	add_action( 'booklovers_action_before_init_theme', 'booklovers_template_team_3_theme_setup', 1 );
	function booklovers_template_team_3_theme_setup() {
		booklovers_add_template(array(
			'layout' => 'team-3',
			'template' => 'team-3',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_side',*/
			'title'  => esc_html__('Team /Style 3/', 'booklovers'),
...
// Template output
if ( !function_exists( 'booklovers_template_team_3_output' ) ) {
	function booklovers_template_team_3_output($post_options, $post_data) {
		$show_title = true;
